![License Badge](https://img.shields.io/badge/license-Apache2.0-yellow.svg)
  ...
  ## Description
  This app using Node.js allows a user to quickly and easily create a professional README file for a new project from their input using the Inquirer packages answering question. 
  <br>
  ...
  ## Installation
  1. Create the file packages include .gitignore file with `node_modules`, `package-lock.json`, `package,json`. 
  2. Run the command lines: `npm init`, `npm install inquirer`,`node index.js`	
  ...
  ## License - This project is licensed under the Apache2.0 license.
  Apache License
